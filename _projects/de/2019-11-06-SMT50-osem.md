...
image3: /images/projects/bodenfeuchte/blockly_sketch_smt50.jpg
...
Hier zeigen wir dir, wie du die Werte des SMT50 mithilfe des WiFi-Bees auf die openSenseMap hochlädst und so auch aus dem Urlaub heraus immer den Überblick über die Bodenfeuchte in deinen Blumehtöpfen behalten kannst!

## Aufbau
Der [truebner SMT50](https://sensebox.kaufen/product/bodenfeuchte-temperatursensor-smt50) ist bereits mit einem JST-Stecker ausgestattet und man kann direkt an einen der Digital-Ports angeschlossen werden. In diesem Projekt wird **Port A** verwendet. Das WiFi-Bee wird auf den Steckplatz **XBEE1** gesteckt.<br>Hier im Bild nochmal der gesamte Aufbau:<br>
...
Auf der darauffolgenden Seite wird nun eine Übersicht der erstellten senseBox angezeigt. Notiere dir die senseBox ID und den beiden Sensor-IDs, jeweils mit dem Phänomen zusammen, um sie später nicht zu vertauschen. Oder lass die Seite für den nächsten Schritt geöffnet und kopiere die IDs einfach rüber.<br>
...
Im `WiFi-Block` musst du noch deinen Netzwerknamen und das WLAN-Passwort eintragen und im `Verbinde mit openSenseMap`- und den `Sende an openSenseMap`-Blöcken die zuvor notierten IDs . Achte darauf die IDs für Bodentemerpatur und Bodenfeuchtigkeit nicht zu vertauschen.
