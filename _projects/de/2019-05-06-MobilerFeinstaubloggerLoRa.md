...
Bevor du die SenseBox mit der [OSeM](http://opensensemap.org) verbinden kannst, musst du dir erst einmal ein [TheThingsNetwork](http://www.console.thethingsnetwork.org) Konto, eine Application und ein Device erstellen. Dabei erhältst du eine Application EUI, eine Device EUI und einen Appkey, diese musst du später im Code eintragen. Dabei ist das Format der Keys und EUI´s wichtig
